  ...
  return (
    <>
      <div>
        <div>
          <img
            className="bloc w-full h-[550px] object-cover py-16"
            ...
            alt=""
          />
          {/*<div className="bg-black/60 fixed w-full h-[550px] top-20 left-0"  />*/}
          <div className="absolute top-[20%] p-4 md:p-8">
            <h1 className="text-3xl md:text-5xl font-bold ">My shows </h1>
            <p className="font-semibold text-gray-400 text-lg">{user.email}</p>
          </div>
        </div>
